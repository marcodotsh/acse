...
typedef struct t_list {
   struct t_list *next; /* The next element in the chain, if it exists,
                         * or NULL instead. */
   struct t_list *prev; /* The previous element in the chain, if it exists,
                         * or NULL instead. */
   void *data;          /* Pointer to the data associated to this element */
} t_list;
 ...
 * @returns A pointer to the new head of the list. */
extern t_list *removeElement(t_list *list, t_list *element);
 ...
 *             deleted.
 * @returns A pointer to the new head of the list. */
extern t_list *removeElementWithData(t_list *list, void *data);
 ...
 * @returns NULL. */
extern t_list *freeList(t_list *list);
