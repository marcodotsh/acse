...
void debugPrintInstruction(t_axe_instruction *instr, FILE *fout)
{
   ...
   switch(instr->opcode)
   {
      ...
      case OPC_ANDL : fprintf(fout, "ANDL "); break;
      case OPC_ORL : fprintf(fout, "ORL "); break;
      case OPC_EORL : fprintf(fout, "EORL "); break;
      case OPC_ANDB : fprintf(fout, "ANDB "); break;
      case OPC_ORB : fprintf(fout, "ORB "); break;
      case OPC_EORB : fprintf(fout, "EORB "); break;
      case OPC_MUL : fprintf(fout, "MUL "); break;
      case OPC_DIV : fprintf(fout, "DIV "); break;
      case OPC_SHL : fprintf(fout, "SHL "); break;
      case OPC_SHR : fprintf(fout, "SHR "); break;
      case OPC_ROTL : fprintf(fout, "ROTL "); break;
      case OPC_ROTR : fprintf(fout, "ROTR "); break;
      case OPC_NEG : fprintf(fout, "NEG "); break;
      case OPC_SPCL : fprintf(fout, "SPCL "); break;
      case OPC_ADDI : fprintf(fout, "ADDI "); break;
      case OPC_SUBI : fprintf(fout, "SUBI "); break;
      case OPC_ANDLI : fprintf(fout, "ANDLI "); break;
      case OPC_ORLI : fprintf(fout, "ORLI "); break;
      case OPC_EORLI : fprintf(fout, "EORLI "); break;
      case OPC_ANDBI : fprintf(fout, "ANDBI "); break;
      case OPC_ORBI : fprintf(fout, "ORBI "); break;
      case OPC_EORBI : fprintf(fout, "EORBI "); break;
      case OPC_MULI : fprintf(fout, "MULI "); break;
      case OPC_DIVI : fprintf(fout, "DIVI "); break;
      case OPC_SHLI : fprintf(fout, "SHLI "); break;
      case OPC_SHRI : fprintf(fout, "SHRI "); break;
      case OPC_ROTLI : fprintf(fout, "ROTLI "); break;
      case OPC_ROTRI : fprintf(fout, "ROTRI "); break;
      case OPC_NOTL : fprintf(fout, "NOTL "); break;
      case OPC_NOTB : fprintf(fout, "NOTB "); break;
      case OPC_NOP : fprintf(fout, "NOP "); break;
      case OPC_MOVA : fprintf(fout, "MOVA "); break;
      case OPC_JSR : fprintf(fout, "JSR "); break;
      case OPC_RET : fprintf(fout, "RET "); break;
      case OPC_HALT : fprintf(fout, "HALT "); break;
      case OPC_SEQ : fprintf(fout, "SEQ "); break;
      case OPC_SGE : fprintf(fout, "SGE "); break;
      case OPC_SGT : fprintf(fout, "SGT "); break;
      case OPC_SLE : fprintf(fout, "SLE "); break;
      case OPC_SLT : fprintf(fout, "SLT "); break;
      case OPC_SNE : fprintf(fout, "SNE "); break;
      case OPC_BT : fprintf(fout, "BT "); break;
      case OPC_BF : fprintf(fout, "BF "); break;
      case OPC_BHI : fprintf(fout, "BHI "); break;
      case OPC_BLS : fprintf(fout, "BLS "); break;
      case OPC_BCC : fprintf(fout, "BCC "); break;
      case OPC_BCS : fprintf(fout, "BCS "); break;
      case OPC_BNE : fprintf(fout, "BNE "); break;
      case OPC_BEQ : fprintf(fout, "BEQ "); break;
      case OPC_BVC : fprintf(fout, "BVC "); break;
      case OPC_BVS : fprintf(fout, "BVS "); break;
      case OPC_BPL : fprintf(fout, "BPL "); break;
      case OPC_BMI : fprintf(fout, "BMI "); break;
      case OPC_BGE : fprintf(fout, "BGE "); break;
      case OPC_BLT : fprintf(fout, "BLT "); break;
      case OPC_BGT : fprintf(fout, "BGT "); break;
      case OPC_BLE : fprintf(fout, "BLE "); break;
      case OPC_LOAD : fprintf(fout, "LOAD "); break;
      case OPC_STORE : fprintf(fout, "STORE "); break;
