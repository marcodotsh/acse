...
static t_instruction *genBFormatInstruction(t_program *program,
      int opcode, int rs1, int rs2, t_label *label)
{
...
t_instruction *genLIInstruction(
...
t_instruction *genLAInstruction(
